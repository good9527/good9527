...
<p align="center">
  <b>🛠️ AI 原生应用探索者 · 桌面客户端深度汉化工具链作者 · 民生开源实践者</b><br/>
  <sub>编程水平：精通跟 AI 说骚话，按回车键让 AI 军团通宵打工</sub>
</p>
...
![Vue3](https://img.shields.io/badge/Vue.js_3-4FC08D?style=flat-square&logo=vuedotjs&logoColor=white)
![Uni-app](https://img.shields.io/badge/uni--app-2B9939?style=flat-square&logo=dcloud&logoColor=white)
![TypeScript](https://img.shields.io/badge/TypeScript-3178C6?style=flat-square&logo=typescript&logoColor=white)
![Vite](https://img.shields.io/badge/Vite-646CFF?style=flat-square&logo=vite&logoColor=white)
![CodeBuddy](https://img.shields.io/badge/CodeBuddy-07C160?style=flat-square)
![WorkBuddy](https://img.shields.io/badge/WorkBuddy-1677FF?style=flat-square)

---

## 💡 核心能力

- 🗣️ **跟 AI 说骚话** — 用最接地气的 prompt 逼 AI 写出最正经严谨的民生级代码
- 🧠 **AI 军团指挥官** — 一句话调度多 Agent 协同做深度 review、自动化测试与全量法规穿透核验
- 🏥 **民生硬核工程** — 穿透 348 个医保统筹区政府红头文件，搭建 7,184 项自动化断言的零幻觉医保预估知识库
- 🔓 **系统级逆向与深研** — 攻破 Windows MSIX 权限锁、ASAR 热注入、四级自愈守护架构
...
<p align="center">
  <sub>⭐ 如果我的开源项目对你有帮助，欢迎点个 Star 鼓励一下！</sub><br/>
  <sub>📮 微信公众号：<b>GIS民工</b> ｜ 微信号：<b>GISmingong2024</b> ｜ 邮箱：<a href="mailto:keepkid0824@gmail.com">keepkid0824@gmail.com</a></sub>
</p>
